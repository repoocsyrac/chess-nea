...
public class ShowWinner extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        winnerLabel.setFont(new java.awt.Font("Microsoft JhengHei", 1, 48)); // NOI18N
        ...
        winnerLabel.setBounds(0, 0, 850, 470);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowWinner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShowWinner dialog = new ShowWinner(new javax.swing.JFrame(), true);
